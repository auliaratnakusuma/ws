...
//check for the part element
//$path = $_SERVER[PATH_INFO];
if ($path != null){
	$path_params = explode ("/", $path); // explode digunakan untuk parsing ngambil data yng punya nim 123 http://localhost/ws.git/xml/bab4/mhs.php/123 
	}
